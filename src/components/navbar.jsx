const NavBar = () => {
  return (
    <>
      <header className="navbar flex justify-between xs:px-1 py-2 sticky top-0 bg-white">
        ...
        <div className="search-bar-wrapper flex bg-blue-50 rounded-md p-1 xs:hidden md:flex h-8 w-[345px] lg:items-center xl:flex-1 cursor-pointer">
          <i className="ri-search-line xs:h-5 md:px-1"></i>
          <div className="input-section">
            <input
              type="text"
              placeholder="Search for Products,Brandsand More"
              className="border-none bg-transparent outline-none xl:w-56"
            />
          </div>
        </div>
        <div className="utilities-section flex items-center lg:w-50 xl:w-[395px]">
          ...
          <div className="signup-wrapper xs:ml-1 sm:ml-2 lg:ml-3">
            <div className="signup-section flex items-center border rounded-md border-white hover:border-gray-400">
              <i class="ri-user-line cursor-pointer xl:mr-2 "></i>
              <p className="xl:mr-2">Alex</p>
          ...
          <div className="utilities flex items-center xs:ml-1 sm:ml-2 lg:ml-3">
            ...
            <div className="menu xs:ml-1 md:ml-0 lg:ml-2 xl:ml-0 cursor-pointer">
              <img
                ...
                alt="menu"
                className="border rounded-md border-white hover:border-gray-400"
              />
            </div>
          </div>
        </div>
